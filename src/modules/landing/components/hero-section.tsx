  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
        ...
        >
          Descubra a Chácara Recanto Canaã em Caratinga, MG. Onde a tranquilidade do campo 
          encontra momentos inesquecíveis. Hospedagem, eventos e gastronomia autêntica.
        </p>
