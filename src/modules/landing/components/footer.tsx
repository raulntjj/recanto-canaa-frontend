    ...
    <footer className="bg-foreground text-background">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-serif text-xl font-bold">Recanto Canaã</h3>
                <p className="text-sm text-background/70">Hotel Fazenda Premium</p>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                ...
                <span>Estrada Rural, Km 15 - Interior/SP</span>
              </a>
              <a
              ...
              <a
                href="mailto:contato@recantocanaã.com.br"
                className="flex items-center gap-3 text-sm text-background/70 hover:text-background"
              >
                <Mail className="h-4 w-4 flex-shrink-0" />
                <span>contato@recantocanaã.com.br</span>
              </a>
            </div>
      ...
      <div className="border-t border-background/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-6 text-sm text-background/60 md:flex-row">
          <p>&copy; {new Date().getFullYear()} Recanto Canaã. Todos os direitos reservados.</p>
          <p>
